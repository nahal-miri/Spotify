...
public:
    Listener(const std::string& fullName, const std::string& userName, const std::string& bio, const std::string& password);
    Listener(const std::string& fullName, const std::string& userName, const std::string& bio, const std::string& password, int id);
